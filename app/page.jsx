      ...
      <main>
        ...
        <section className="hero">
          <div className="hero__content">
            <p className="kicker">AI Builder &middot; Agentic Systems Engineer</p>
            <h1>
              <Typewriter text="Building production AI systems that reason, act, and automate real workflows." />
            </h1>
